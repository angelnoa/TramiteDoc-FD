...
<style type="text/css">
	...
	*/
	...
	#complementofirmantes, #complementovistobueno {
		visibility:hidden;
		position:fixed;
		float: center;
		padding:2px;
...
/*$(function() {
  ...
  $( "#tabsproyectos" ).tabs();
   ...
   $("#botoninvisiblefirmante").mouseover(function(event){
	      $("#botoninvisiblefirmante").addClass("buttoncss");
	   });
   $("#botoninvisiblefirmante").mouseout(function(event){
	      $("#botoninvisiblefirmante").removeClass("buttoncss");
	});
   
   $("#botoninvisiblevistobueno").mouseover(function(event){
	      $("#botoninvisiblevistobueno").addClass("buttoncss");
	   });
	$("#botoninvisiblevistobueno").mouseout(function(event){
	      $("#botoninvisiblevistobueno").removeClass("buttoncss");
	});
		   
	$('#botoninvisible').click(function(e) {
		 e.preventDefault();
         var $this = $(this);
         var horizontalPadding = 15;
         var verticalPadding = 15;
         refDialog = $('<iframe id="site" src="mostrarlistasdebandejadocumentosinternos.do?cambia=1" />').dialog({
	...
	$('#botoninvisibleProyectos').click(function(e) {
		e.preventDefault();
        var $this = $(this);
        var horizontalPadding = 15;
        var verticalPadding = 15;
        refDialog = $('<iframe id="site" src="mostrarlistasdebandejadocumentosinternos.do?cambia=2" />').dialog({
            title: ($this.attr('title')) ? $this.attr('title') : 'Site',
            autoOpen: true,
            width: 1000,
            height: 300,
	...
	$('#botoninvisiblefirmante').click(function() {
		$("#complementofirmantes").css("visibility","visible");
  	   	$("#capaFondo1").css("visibility","visible");
	});
	
	$('#botoninvisiblevistobueno').click(function() {
		$("#complementovistobueno").css("visibility","visible");
  	   	$("#capaFondo1").css("visibility","visible");
	});
	...
	$(document).ready(function(){
		...
		$("#cerrar-complemento-firmantes").click(function () {
	    	   $("#complementofirmantes").css("visibility","hidden");
	    	   $("#capaFondo1").css("visibility","hidden");
	    });
		
		$("#cerrar-complemento-vistobueno").click(function () {
	    	   $("#complementovistobueno").css("visibility","hidden");
	    	   $("#capaFondo1").css("visibility","hidden");
	    });
...
function modificarIframe(valor){
	var strURL = "ModificarDocumentoInterno.do?cod_doc_interno="+valor;
	location=strURL;
	
	return;
}

function modificarIframeProyectos(valor){
	var strURL = "ModificarDocumentoInterno.do?cod_doc_interno="+valor+"&tipo_pi=1";
	location=strURL;
	
	return;
}

function modificarIframeMisProyectos(cod_doc_int_origen,codigo_documento_interno,codigo_documento){
	var strURL = "ModificarDocumentoInterno.do?cod_doc_interno="+cod_doc_int_origen+"&cod_proy="+codigo_documento_interno+"&numreg="+codigo_documento+"&tipo_pi=2";
	location=strURL;
...
function verdato(){
	...
	var frame = document.getElementById('iframeSearch');
	var txt = frame.contentWindow.document.getElementById('txtDefaultHtmlArea').value;
	//alert(txt);
	$("#descripcion-iframe").val(txt);	
	
	//alert("hola"+document.forms[0].firmantes_destino.value);
}
...
<div id="container">
	...
	<INPUT  type="hidden" id="descripcion-iframe" name="descripcion-iframe" value="">
	...
	<!-- 
	<div id="complementofirmantes" class="rounded">
	<div id="Theadsmall"><div style="padding:7px">Firmantes</div></div>
		<br><br>
    	<div id="confirmantes" style="background: white;  width:300px; height:180px; overflow: scroll; line-height: 100%; FONT-SIZE: 8pt; padding-left:5px; text-align: left; " class="input">	
				<logic:iterate id="oficinas_des" name="areasAdministrativasList" >
				   <html:multibox  styleId="firmantes_destino" property="firmantes_destino" >	
    	...
    	<input type="button" id="cerrar-complemento-firmantes" class="button" value="Cerrar"></div>
    	<br>
	</div>
	
	<div id="complementovistobueno" class="rounded">
	<div id="Theadsmall"><div style="padding:7px">Visto Bueno</div></div>
		<br><br>
    	<div id="vistobueno" style=" display:visibility; background: white;  width:300px; height:180px; overflow: scroll; line-height: 100%; FONT-SIZE: 8pt; padding-left:5px; text-align: left; " class="input">	
				<logic:iterate id="oficinas_des" name="areasAdministrativasList" >
				   <html:multibox  styleId="visto_bueno_destino" property="visto_bueno_destino" >	
				    <bean:write name="oficinas_des" property="codigo_oficina"/> 
				   </html:multibox> 
				   <label class="caja7"><bean:write name="oficinas_des" property="descripcion_oficina"  /></label>
				   <br>
    	...
    	<br>
    	<div style="margin-left:80%;">
    	<input type="button" id="cerrar-complemento-vistobueno" class="button" value="Cerrar"></div>
    	<br>
	</div>
	-->
	...
	<div id="Theadsmall"><div style="padding:7px">Firmantes</div></div>
		<br><br>
		<div style="width:20px;  height:180px; position:relative; float:left;"></div>
    	<div id="confirmantes" style="position:relative; float:left; background: white;  width:300px; height:180px; overflow: scroll; line-height: 100%; FONT-SIZE: 8pt; padding-left:5px; text-align: left; " class="input">	
				<logic:iterate id="oficinas_des" name="areasAdministrativasList" >
				   <html:multibox  styleId="firmantes_destino" property="firmantes_destino" >	
				    <bean:write name="oficinas_des" property="codigo_oficina"/> 
				   </html:multibox> 
		...
		<div style="width:15px;  height:180px; position:relative; float:left;"></div>
    	<div style="width:350px;  height:30px; position:relative; float:left;"></div>
	...
	<div id="Theadsmall"><div style="padding:7px">Visto Bueno</div></div>
		<br><br>
		<div style="width:20px;  height:180px; position:relative; float:left;"></div>
    	<div id="vistobueno" style="position:relative; float:left; background: white;  width:300px; height:180px; overflow: scroll; line-height: 100%; FONT-SIZE: 8pt; padding-left:5px; text-align: left; " class="input">	
				<logic:iterate id="oficinas_des" name="areasAdministrativasList" >
				   <html:multibox  styleId="visto_bueno_destino" property="visto_bueno_destino" >	
				    <bean:write name="oficinas_des" property="codigo_oficina"/> 
				   </html:multibox> 
				   		...
				   		<c:otherwise>
				    		<span class="labelrounded">DOCUMENTO POR FIRMAR</span> 
 						    	...
 						    	<c:otherwise>
 						    		...
 						    		<div id="cradio5" style="width:100px; position: absolute; top:7px; FONT-SIZE: 8pt;  font-weight:bold; left:75%;">
					          			  <a  href="javascript:Regresar()" title="Regresar a la Bandeja de Documentos por Firmar" ><img src="img/01regresar.png"  width="16" height="16" border="0" align="top"> Regresar</a>
							  		</div>
 						    	</c:otherwise>
 						    </c:choose>
				   		   	</c:when>
    ...
    <div  style="width: 100%;  height: 40px;  position:relative; ">
    	<div  id ="botoninvisiblefirmante" title="Ver Firmantes" style="width:110px; height:20px; position: absolute; top: 24px; padding: 3px 10px; text-align: center;  FONT-SIZE: 8pt; font-weight:normal; left:82%;  color: #003366;  line-height: 20px;" >&nbsp;<img  src="img/im-user-black.png"  style=" vertical-align: middle; width:20px; height:20px;  border:0px; ">&nbsp;&nbsp;Firmantes</div>
		 <div  id ="botoninvisiblevistobueno" title="Ver Visto Bueno" style="width:110px; height:20px; position: absolute; top: 54px; padding: 3px 10px; text-align: center;  FONT-SIZE: 8pt; font-weight:normal; left:82%;  color: #003366;  line-height: 20px;" >&nbsp;<img  src="img/ok.png"  style=" vertical-align: middle; width:20px; height:20px;  border:0px; ">&nbsp;&nbsp;V. Bueno</div>
	</div>
	<table width="800px" cellspacing="0" border="0">
			 <tr>
				   <td  style="padding:0px; margin:0px;" align="center" valign="middle" >
				   		<table  width="770px" border="0">
				   		<tr><td colspan="2" height="20px" >	&nbsp;	</td>
				   		</tr>
				   		<tr>
				   			<td  width="250px" height="35px" align="right" valign="middle" class="label" >
				    			<bean:message key="sistema.documento.internos.registrar" />  
				  			</td>
				  			<td  width="570px" height="35px" align="left" valign="middle" >
						...
						<tr>
				   			<td  width="250px"  height="35px" align="right" valign="middle" class="label" >
				    			<bean:message key="sistema.documento.internos.institucion" />  
				  			</td>
				  			<td  width="570px"  height="35px" align="left" valign="middle" >
				  			<div id="no-muestra2" style="display:visibility;">
				    			<select id="codigo_intitucion" name="codigo_intitucion"
									class="input-medium" onchange="showInstituciones()">
									
									<OPTION value="2">CONCYTEC</OPTION>
									
								</select>
								<span class="error" ><html:errors property="codigo_tipo_documento_interno"/></span>
							</div>
				  			</td>
				   		</tr>
				   		<tr>
				  			...
				  			<div id="no-muestra3" style="display:visibility;">
				    			<select
									...
									<c:choose>
										<c:when test='${not empty areasAdministrativasList}'>
											<c:forEach items='${areasAdministrativasList}' var='pa'>
							...
							<!--  
				    			<html:select property="codigo_oficina" styleId="codigo_oficina"  onchange="showProducts()" styleClass="input">			             
					             <html:option value="0" >Seleccionar</html:option>
				   		...
				   		<tr>
				  			...
				  			<td  width="570px" height="35px" align="left" valign="middle" >
				  			<div class="ui-widget">
				    			<html:text property="abreviatura_grado_profesion"  size="10" styleId="abreviatura_grado_profesion"  onkeypress="return validatecla('texto',this)" styleClass="input-medium"/>
				   		...
				   		<tr>
				  			...
				  			<td  width="570px" align="left" valign="top" >
				    			 <html:textarea property="asunto" styleId="asunto" title="Ingresar Asunto" style="width:500px; height:90px;" styleClass="textarea"/> 
				   		...
				   		<tr>
				  			...
				  			<td  align="left" valign="middle" >
				    			<html:textarea property="referencia" styleId="referencia" style="width:500px; height:50px; " styleClass="textarea" /> 
				  			</td>
				   		...
				   		<tr>
				  			...
				  			<td  align="left" valign="middle" >
				  			<iframe id="iframeSearch" src="default_texto.jsp" width="500" height="280" frameborder="0" scrolling="yes" marginheight="0" marginwidth="0"></iframe> 
				  			
			  			
			    			<!--<html:textarea property="descripcion"  styleId="descripcion"  style="width:500px; height:200px;" styleClass="textarea"/>
				   		...
				   		<table width="770px" border="0">
				   		<tr>
				   		<td width="240px" height="35px" align="right" valign="middle" class="label" ><bean:message key="sistema.documento.internos.autor" /></td>
				   		<td width="200px" align="left" valign="middle" >
				   		<div id="no-muestra4" style="display:visibility;">
				   		<html:text property="firmado_por" size="37"  styleId="firmado_por" onkeypress="return validatecla('letras',this)" styleClass="input-medium" style="width:150px;"/>
								 <span class="error"><br><html:errors property="firmado_por"/></span>
						</div> 
						</td>
						<td width="140px" align="left" valign="middle"  class="label" >
						<div id="v-ocultar-5" style="display:visibility;" >
						<div id="clickme" >
				    			<p><label><bean:message key="sistema.documento.internos.copias_destinatario" /></label></p>
				    	</div>
				    	</div>
				    	...
				    	<td  width="190px">
				   		...
				   		<div id="v-ocultar-4" style="display:visibility;" >
				   			<div id="concopia" style=" display:visibility; background: white;   height:80px; overflow: scroll; line-height: 100%; FONT-SIZE: 8pt; padding-left:5px;" class="input">	
										<logic:iterate id="oficinas_des" name="areasAdministrativasList" >
				   		...
				   		<tr>
				   		<td align="right" valign="middle" class="label" ><bean:message key="sistema.documento.internos.estado" /></td>
				   		<td align="left" valign="middle" >
				   		...
				   		<tr>
				   			<td  align="center" valign="top" class="label" colspan="2" >
									 ...
									 <c:when test='${FFormDocumentoInterno.codigo_documento_interno eq null }'>
									      ...
									      <html:button  value="Guardar" style="width: 90;" property="" styleClass="button" onclick="this.disabled=true; verdato(); this.value='GUARDANDO...'; this.form.submit()" />
					         		 ...
					         		 <c:when test='${verbotonescreacion == "1" && es_admiitido==0}'>
					         		 	...
					         		 	<c:otherwise>
					         		 	<html:button  value="Actualizar" style="width: 90;" property="" styleClass="button" onclick="this.disabled=true; verdato(); this.value='ACTUALIZANDO...'; this.form.submit()" />
									 ...
									 <c:otherwise>
									 	...
									 	<c:when test='${es_proyecto == "1"}'>
									 	<html:button  value="Guardar3" style="width: 90;" property="" styleClass="button" onclick="this.disabled=true; this.value='GUARDANDO...'; this.form.submit()" />
									 	<html:reset value="Cancelar" style="width: 90;" styleClass="button" />
									 	</c:when>
									 	<c:otherwise>
									 	<html:button  value="Actualizar" style="width: 90;" property="" styleClass="button" onclick="this.disabled=true; verdato(); this.value='ACTUALIZANDO...'; this.form.submit()" />
	...
	<div id="tabs">
  <ul>
    <li><a href="#tabs-1">Documentos Creados</a></li>
  ...
  <table width="100%">
			 ...
			 <tr>
				  <td align="center" colspan="2">				  
				  <display:table name="sessionScope.listaDocumentosInternosFull"  requestURI="/MostrarFormularioCrearcionDocumentoInterno.do?inicia=SI#tabs-1"
				  export="false" sort="list" id="b" 
				  pagesize="8"  class="simple" style="width: 90%" >
