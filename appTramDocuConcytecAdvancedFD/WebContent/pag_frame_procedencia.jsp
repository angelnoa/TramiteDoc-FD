...
<form  id="form_datos" name="form_datos" method="post" action="">
  <table width="100%" border="1" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td height="25" align="center" valign="middle"> <b> <A id="A1"  target="_parent" href="ValidaPaginas.do?tipo=seleccion&codigo_persona=<c:out value='${pr.codigo_persona}'/>&nombre_persona=<c:out value='${pr.nombre_persona}'/>&tipodoc=<c:out value='${pr.tipo}'/>&operacion=T&accion_p=<c:out value='${accion_p}'/>"  > 
      ...
      <td width="71" align="center" valign="middle"> <b><A id="A1" target="_parent" href="DetalleFrame.do?tipo=procedencia&codigo_persona=<c:out value='${pr.codigo_persona}'/>&nombre_persona=<c:out value='${pr.nombre_persona}'/>&tipodoc=<c:out value='${pr.tipo}'/>&operacion=M&accion=<c:out value='${accion_p}'/>"> 
        <font color="#0000FF">Modificar</font> </A></b> </td>
      <td width="69" align="center" valign="middle"><b> <A id="A1" target="_parent" href="DetalleFrame.do?tipo=procedencia&codigo_persona=<c:out value='${pr.codigo_persona}'/>&nombre_persona=<c:out value='${pr.nombre_persona}'/>&tipodoc=<c:out value='${pr.tipo}'/>&operacion=E&accion=<c:out value='${accion_p}'/>"> 
