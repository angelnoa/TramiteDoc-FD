...
<html>
  ...
  <!--DWLayoutTable-->
  <tr >
    <td height="28" align="left" valign="middle" class="label">&nbsp;&nbsp;&nbsp;&nbsp;<strong>B&uacute;squeda 
      por :</strong> </td>
    <td width="200">&nbsp;</td>
    <td width="366">&nbsp;</td>
  </tr>
  <tr>
    <td height="36" colspan="3" valign="middle" class="label"><form name="frmBuscarDocs" id="frmBuscarDocs"  method="get" action="ListaDocumentos.do"><table width="100%" border="0">
          <tr>
            <td width="6%" class="label">N&deg; Registro: </td>
            <td width="12%">
			<input type="hidden" name="tipo" value="modificar"/>
			<input type="hidden" name="operacion" value="MD"/>
			<input type="text" name="codigo_doc" id="codigo_doc" value="<c:out value='${codigo_doc}'/>" size="20" class="caja"></td>
            <td width="8%"><input type="submit" name="button2" class="boton" value="Buscar" alt="buscar"></td>
            <td width="74%"><input type="button" name="button" class="boton" value="Listar Todos" onClick="listar_todos()" alt="Listar Todos"></td>
          </tr>
        </table>
    </form>
	</td>
							  ...
							  <tr><td width="608" height="26" align="right" valign="middle" class="label">Reversi&oacute;n de Documentos Derivados</td>
							<td width="366" align="right" valign="middle"><A  href="javascript:regresar()"><img  src="img/salir.gif" alt="Ir a la lista Derivaci&oacute;n Documentos" border="0" height="30" ></A> &nbsp;&nbsp;&nbsp;</td>
						    </tr></table>
					</td>
				</tr>
				<tr>
 			...
 			<html:hidden property="secuencia_movimiento"  />
				   ...
				   &nbsp;dd/mm/yyyy				 	</td>
					...
					<html:textarea property="observacion" style="width: 200px;"  styleClass="caja"/>							  </td>
							...
							<tr>
								<td height="10" colspan="7" style="height: 10px;">	
