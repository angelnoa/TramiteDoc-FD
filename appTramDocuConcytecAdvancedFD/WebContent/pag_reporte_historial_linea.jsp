...
<TR ><TD align="left" height="50" width="100%"><table width="100%" height="50" cellspacing="0" cellpadding="0"  align="left">
						<tr><td bgcolor="a8b5c8">  <jsp:include page="/headTramite.jsp"/>   </td></tr></table></TD></TR>
        ...
        <TBODY>
          ...
          <TR> 
            <TD height="100%" colspan="8" valign="top" class="tablepar"><TABLE width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#ffffff" bgcolor="#ffffff" height="170">
                <TR> 
                  <TD> <IFRAME id="ifra_listadocumentos" name="ifra_listadocumentos" align="top" src="VerFrameListas.do?tipo=reportehistoriallinea&codigo_documento=<c:out value='${detalleConsulta.codigo_documento}'/>" frameBorder="0" width="100%" height="100%" scrolling="auto" ></IFRAME> 
                  </TD>
                </TR>
              </TABLE></TD>
          </TR>
