...
table.gridtable th {
	...
	background: url(http://es2.abcimg.es/img/fd-marcador.gif) repeat-x top left; 
	margin:20px 0 7px; 
	width:478px; 
	height:52px
}
...
<body>
 ...
 <br /><br /><br /><br />
		<table id="tblUsuarios" align="center" class="gridtable" style="font-size: 12px;">
				<thead>
					<tr>
						<th>Usuario</th>
						<th>Oficina</th>
				...
				<tbody style="text-align: left; ">
					<c:forEach items='${ListUsuarios}' var='pr' varStatus="c">
						<tr>
							<td><a
								href="LoginGoogle.do?usu=<c:out value='${pr.usuario}' />"> <c:out
										value='${pr.usuario}' />
							</a></td>
							<td><c:out value='${pr.nombre_corto}' />
							- <b><c:out value='${pr.nombre_institucion}' /></b> 
