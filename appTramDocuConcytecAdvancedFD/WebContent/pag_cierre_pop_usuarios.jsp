...
<HEAD>
    ...
    <TITLE>Busqueda de Usuarios de Oficinas</TITLE>
...
<script>
function seleccionar2(codigo,nombre,oficina){

opener.document.getElementById('remitente').value=codigo;
opener.document.getElementById('nombre_remitente').value=nombre+" - "+oficina;
window.close();
}
function buscar(){
...
var strURL = "Busquedas.do?tipo=usuarios";
...
<table height="466" border="0" width="500">
  <!--DWLayoutTable-->
  <tr>
    <td height="10" colspan="2" class="label1">Busqueda de Usuarios </td>
  </tr>
  <tr>
