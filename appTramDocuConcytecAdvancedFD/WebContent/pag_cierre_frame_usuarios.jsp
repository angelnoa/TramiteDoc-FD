...
function seleccionar(codigo,nombre,oficina){
 
 
 parent.seleccionar2(codigo,nombre,oficina);
...
<table height="44" border="0" width="450">
  ...
  <tr>
    ...
    <td height="5" valign="top" class="groupcell2">Usuario</td>
    <td height="5" valign="top" class="groupcell2">Oficina</td>
  </tr>
  <c:forEach items="${usuarios}" var="us">
  <tr>
    <td width="440" height="15" valign="top"><label>
      <input type="submit" name="Submit" value="Seleccionar" onClick="javascript:seleccionar('<c:out value="${us.usuario}"/>','<c:out value="${us.nombres}"/> <c:out value="${us.apellidos}"/>','<c:out value="${us.descripcion_oficina}"/>');">
    </label></td>
    <td width="440" valign="top"><c:out value="${us.nombres}"/> <c:out value="${us.apellidos}"/></td>
    <td width="440" valign="top"><c:out value="${us.descripcion_oficina}"/></td>
  </tr></c:forEach>
</table>
