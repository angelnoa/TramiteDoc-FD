    ...
    $( "#dialog-confirm-retorno-documentos-normales" ).dialog({
      ...
      buttons: {
        "Retornar documento": function() {
          ...
          //alert(codigo);
          var strURL = "FormularioBusquedaDocumentoInterno.do?inicia=SI&tipo=proyectos&operacion=retorno&cod_doc_interno="+codigo;
          location = strURL;
          $( this ).dialog( "close" );
        },
        Cancelar: function() {
...
<div class="container">
	...
	<div id="dialog-confirm-retorno-documentos-normales" title="Mensaje de Alerta" >
  		...
  		El documento será retornado a la bandeja de documentos en estado borrador.
	</div>
	...
	<div id="TDHeadCab">
				    		...
				    		<span class="labelrounded">BANDEJA PROYECTOS</span> 
  ...
  <div id="tabsbusquedabandeja">
	...
	<c:choose>
	  ...
	  <div id="tabs">
	  <ul>
	   	<li><a href="#tabsbandeja-1">Proyectos Creados</a></li>
