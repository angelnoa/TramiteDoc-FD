...
function ModificarEstado(nombre){
	...
	location = "AdjuntarDocumentoInternoEspecialC.do?operacion="+ls_operacion+"&nombre="+nombre;
	
}

function eliminar_archivo(id){
if(confirm("Desea Eliminar este archivo?")){
location = "Busquedas.do?tipo=eli_archivo_interno_especialc&id="+id;
}
}
	...
	for (var i = 0; i < extensiones_permitidas.length; i++) { 
		 ...
		 if (!permitida) { 
             ...
             return false;
	  		 ...
	  		 document.form_datos.action='AdjuntarDocumentoInternoEspecialC.do?operacion='+ls_operacion;
...
<div id="uploadcontainer">
    ...
    <td align="center" valign="middle"><A id="A1" target="_parent" href="AdjuntarDocumentoInternoEspecialC.do?operacion=EDIF&nombre=<c:out value='${pr.nombre_archivo}'/>&cod_doc_interno=<c:out value='${pr.tipo_archivo}'/>">
      ...
      <c:forEach items='${FFormDocumentoInternoEspecialC.archivos}' var='ar' varStatus="c"> 
	...
	<td align="center" valign="middle" class="Columna"><a href="Busquedas.do?tipo=ver_archivo_interno_especialc&id=<c:out value='${c.count-1}'/>">Visualizar</a></td>
  		...
  		<div id="tabsbusquedabandeja">
            ...
            <c:when test='${operacioninterno == "O"}'>
				...
				<tr>
				  ...
				  <display:table name="sessionScope.listaDocumentosInternosProyectosTdr" export="false" sort="list" id="b" pagesize="5"  class="simple" style="width: 100%">
