...
<div class="container">
  ...
  <div id="tabsbandeja-1">
	<table width="100%" cellpadding="0" cellspacing="0">
			 ...
			 <tr>
				  <td align="center" colspan="2">				  
				  <display:table name="sessionScope.listaDocumentosInternosN" requestURI="/FormularioBusquedaDocumentoInterno.do?inicia=SI&tipo=firma#tabsbandeja-1"
				  export="false" sort="list" id="b" 
				  pagesize="8"  class="simple" style="width: 90%" >
	...
	<table width="100%" cellpadding="0" cellspacing="0">
			 ...
			 <tr>
				  <td align="center" colspan="2">				  
				  <display:table name="sessionScope.listaDocumentosInternosD" requestURI="/FormularioBusquedaDocumentoInterno.do?inicia=SI&tipo=firma#tabsbandeja-2"
				  export="false" sort="list" id="b" 
				  pagesize="8"  class="simple" style="width: 90%" >
	...
	<table width="100%" cellpadding="0" cellspacing="0">
			 ...
			 <tr>
				  <td align="center" colspan="2">				  
				  <display:table name="sessionScope.listaDocumentosInternosR" requestURI="/FormularioBusquedaDocumentoInterno.do?inicia=SI&tipo=firma#tabsbandeja-3"
				  export="false" sort="list" id="b" 
				  pagesize="8"  class="simple" style="width: 90%" >
