...
function Cambiardocumento(valventana){
	
		var vvalor=valventana;
		if (vvalor==1){
...
function CargarTabla(){
	//alert("entre a cargatabla")
	var numerodefilas = document.forms[0].numerofilas.value;
	//alert(numerodefilas);
	
	if(numerodefilas>0){
		for (var i=0; i<4; i++) {  
			 //i recorre las 4 tablas que forman una fila
			  tab = 'tabla'+(i+1);
			  //alert(tab)
			  ...
			  if (i == 0){
				  newid = 'meta1form';  
				  txt = '<input type="text" id="' + newid  + '" name="' + newid  + '" size="35" value="<c:out value='${FFormDocumentoInternoEspecialC.meta1form}'/>" />'
			  }
			  if (i == 1){
				  newid = 'especifica1form'; 
				  txt = '<input type="text" id="' + newid  + '" name="' + newid  + '" size="35" value="<c:out value='${FFormDocumentoInternoEspecialC.especifica1form}'/>" />'
			  }
			  if (i == 2){
				  newid = 'valor1form';  
				  txt = '<input type="text" id="' + newid  + '" name="' + newid  + '" size="35" value="<c:out value='${FFormDocumentoInternoEspecialC.valor1form}'/>" />'
			  }
			  if (i == 3){
				  newid = 'observacion1form';  
				  txt ='<textarea id="' + newid  + '" name="' + newid  + '" cols="60" rows="2"  value="<c:out value='${FFormDocumentoInternoEspecialC.observacion1form}'/>" />'
			  }
		...
		if(numerodefilas>1){
			for (var i=0; i<4; i++) {  
				 //i recorre las 4 tablas que forman una fila
				  ...
				  if (i == 0){
					  newid = 'meta2form';  
					  txt = '<input type="text" id="' + newid  + '" name="' + newid  + '" size="35" value="<c:out value='${FFormDocumentoInternoEspecialC.meta2form}'/>" />'
				  }
				  if (i == 1){
					  newid = 'especifica2form'; 
					  txt = '<input type="text" id="' + newid  + '" name="' + newid  + '" size="35" value="<c:out value='${FFormDocumentoInternoEspecialC.especifica2form}'/>" />'
				  }
				  if (i == 2){
					  newid = 'valor2form';  
					  txt = '<input type="text" id="' + newid  + '" name="' + newid  + '" size="35" value="<c:out value='${FFormDocumentoInternoEspecialC.valor2form}'/>" />'
				  }
				  if (i == 3){
					  newid = 'observacion2form';  
					  txt ='<textarea id="' + newid  + '" name="' + newid  + '" cols="60" rows="2"  value="<c:out value='${FFormDocumentoInternoEspecialC.observacion2form}'/>" />'
				  }
			...
			if(numerodefilas>2){
				for (var i=0; i<4; i++) {  
					 //i recorre las 4 tablas que forman una fila
					  ...
					  if (i == 0){
						  newid = 'meta3form';  
						  txt = '<input type="text" id="' + newid  + '" name="' + newid  + '" size="35" value="<c:out value='${FFormDocumentoInternoEspecialC.meta3form}'/>" />'
					  }
					  if (i == 1){
						  newid = 'especifica3form'; 
						  txt = '<input type="text" id="' + newid  + '" name="' + newid  + '" size="35" value="<c:out value='${FFormDocumentoInternoEspecialC.especifica3form}'/>" />'
					  }
					  if (i == 2){
						  newid = 'valor3form';  
						  txt = '<input type="text" id="' + newid  + '" name="' + newid  + '" size="35" value="<c:out value='${FFormDocumentoInternoEspecialC.valor3form}'/>" />'
					  }
					  if (i == 3){
						  newid = 'observacion3form';  
						  txt ='<textarea id="' + newid  + '" name="' + newid  + '" cols="60" rows="2"  value="<c:out value='${FFormDocumentoInternoEspecialC.observacion3form}'/>" />'
					  }
				...
				if(numerodefilas>3){
					for (var i=0; i<4; i++) {  
						 ...
						 // alert(tab)
						  ...
						  if (i == 0){
							  newid = 'meta4form';  
							  txt = '<input type="text" id="' + newid  + '" name="' + newid  + '" size="35" value="<c:out value='${FFormDocumentoInternoEspecialC.meta4form}'/>" />'
						  }
						  if (i == 1){
							  newid = 'especifica4form'; 
							  txt = '<input type="text" id="' + newid  + '" name="' + newid  + '" size="35" value="<c:out value='${FFormDocumentoInternoEspecialC.especifica4form}'/>" />'
						  }
						  if (i == 2){
							  newid = 'valor4form';  
							  txt = '<input type="text" id="' + newid  + '" name="' + newid  + '" size="35" value="<c:out value='${FFormDocumentoInternoEspecialC.valor4form}'/>" />'
						  }
						  if (i == 3){
							  newid = 'observacion4form';  
							  txt ='<textarea id="' + newid  + '" name="' + newid  + '" cols="60" rows="2"  value="<c:out value='${FFormDocumentoInternoEspecialC.observacion4form}'/>" />'
						  }
...
function addNewRow()
{
  ...
  for (var i=0; i<4; i++) {
	 ...
	 // alert(tab)
	  ...
	  if (i == 0){
		  newid = 'meta' + (numeroz) + 'form';
		  val = 
		  txt = '<input type="text" id="' + newid  + '" name="' + newid  + '" size="35" />'
	  }
	  if (i == 1){
		  newid = 'especifica' + (numeroz) + 'form'; 
		  txt = '<input type="text" id="' + newid  + '" name="' + newid  + '" size="35" />'
	  }
	  if (i == 2){
		  newid = 'valor' + (numeroz) + 'form';  
		  txt = '<input type="text" id="' + newid  + '" name="' + newid  + '" size="35" />'
	  }
	  if (i == 3){
		  newid = 'observacion' + (numeroz) + 'form';  
		  txt ='<textarea id="' + newid  + '" name="' + newid  + '" cols="60" rows="2"  />'
	  }
...
function Guardar(){
	...
	var text = document.forms[0].btnguardar.value;
	if(text == 'GUARDANDO...'){
		text = 'Guardar';
	}
	if(text == 'ACTUALIZANDO...'){
		text = 'Actualizar';
	}
	
	if(numero == 0){
		if (Validarcampovacio(document.forms[0].especifica.value) == false)
	    {              
	          alert("Ingresar Especifica");
	          document.forms[0].btnguardar.value=text;
	          document.forms[0].btnguardar.disabled = false;
	          document.forms[0].especifica.focus();
	...
	if(numero == 1){
	if (Validarcampovacio(document.forms[0].especifica1form.value) == false)
    {              
          alert("Ingresar Especifica");
          document.forms[0].btnguardar.value=text;
          document.forms[0].btnguardar.disabled = false;
          document.forms[0].especifica1form.focus();
          return false;           
    }
	}
	if(numero == 2){
		...
		if (Validarcampovacio(document.forms[0].especifica2form.value) == false)
	    {              
	          alert("Ingresar Especifica");
	          document.forms[0].btnguardar.value=text;
	          document.forms[0].btnguardar.disabled = false;
	          document.forms[0].especifica2form.focus();
	          return false;           
	    }
	}
	if(numero == 3){
		...
		if (Validarcampovacio(document.forms[0].especifica3form.value) == false)
	    {              
	          alert("Ingresar Especifica");
	          document.forms[0].btnguardar.value=text;
	          document.forms[0].btnguardar.disabled = false;
	          document.forms[0].especifica3form.focus();
	          return false;           
	    }
	}
	if(numero == 4){
		...
		if (Validarcampovacio(document.forms[0].especifica4form.value) == false)
	    {              
	          alert("Ingresar Especifica");
	          document.forms[0].btnguardar.value=text;
	          document.forms[0].btnguardar.disabled = false;
	          document.forms[0].especifica4form.focus();
	          return false;           
	    }
	}
	document.forms[0].numerofilas.value = numero;
	//alert("Numerofilas -"+numero);
...
<script language="JavaScript" type="text/javascript">
 ...
 function AgregarDocInternos() {
		var strURL="AdjuntarDocumentoInternoEspecialC.do";
 ...
 function EstadoPreparar(){
	//	var strURL="ModificarDocumentoInternoEspecialC.do?cod_doc_interno=0&operacion=DDI";
	//	location=strURL;
	//	return;
	}
...
function cerrar() {
 ...
 function Regresar(){
	...
	/*	alert(var_apellido_paterno);
		...
		var strURL = "MostrarFormularioCrearcionDocumentoInternoEspecialC.do?tipo=firma";
		location=strURL;
...
<body bgColor="#F0F5FB" onload="CargarTabla(); fn_onLoad();" >
	<html:form  enctype="multipart/form-data"  action="CrearDocumentoInternoEspecialC.do"  > 
	...
	<INPUT  type="hidden" id="pcodigodocumentointerno" name="pcodigodocumentointerno" value="<c:out value='${FFormDocumentoInternoEspecialC.codigo_documento_interno}'></c:out>">
	<INPUT  type="hidden" id="ptipocodigodocumentointerno" name="ptipocodigodocumentointerno" value="<c:out value='${FFormDocumentoInternoEspecialC.codigo_tipo_documento_interno}'></c:out>">
	...
	<div id="cerrar-aviso-checked" style="cursor:pointer; position: absolute;  width:10%; height:40px; top:15px; left:90%; text-align:left;">  </div>
		El archivo generado sera un Proyecto<br>con restricciones de uso
		&nbsp;&nbsp;
	</div>
	...
	<!-- div id="TDHeadCab">
	 <c:choose>
				   		<c:when test='${es_admiitido==0}'>
				  			...
				  			<div class="linklista">&nbsp;&nbsp;&nbsp;
				   		   	<c:choose>
				   		   	<c:when test='${ls_respuesta == "respuesta" && FFormDocumentoInternoEspecialC.codigo_documento eq 0 }'>
				   		   			<c:out value='${ls_codigo_documento}'></c:out>
				   		   	</c:when>
				   		   	</c:choose>
				   		   	<c:choose>
				   		   	<c:when test='${FFormDocumentoInternoEspecialC.codigo_documento > 0}'>
				   		   		<c:out value='${FFormDocumentoInternoEspecialC.codigo_documento}'></c:out>
				   		   	</c:when>
				   		   	</c:choose>
				   		   	</div>
				   		</c:when>
	...
	<div id="TDHeadCab">
	 ...
	 <c:choose>
				   		...
				   		<c:when test='${es_admiitido==0}'>
				   		   	...
				   		   	<c:when test='${ls_respuesta == "respuesta" && FFormDocumentoInternoEspecialC.codigo_documento eq 0 }'>
				   		   	<c:choose>
				   		   	<c:when test='${FFormDocumentoInternoEspecialCInterno.tipo_envio =="R"}'>
					          <div id="cradio1" style="width:100px; position: absolute; top:7px; FONT-SIZE: 8pt;  font-weight:bold; left:75%;">
				   		   	...
				   		   	<c:when test='${FFormDocumentoInternoEspecialC.codigo_documento > 0 }'>
				   		   	<c:choose>
				   		   	<c:when test='${FFormDocumentoInternoEspecialC.tipo_envio =="R"}'>
				   		   	<c:choose>
							  	...
							  	<div id="cradio2" style="width:200px; position: absolute;  top:7px; FONT-SIZE: 8pt;  font-weight: bold; left:65%;">
    									  ...
    									  <a  href="javascript:deletedocument(<c:out value='${FFormDocumentoInternoEspecialC.codigo_documento_interno}' />)"  title="Eliminar Documento" ><img src="img/02eliminar.png"  width="16" height="16" border="0" align="top"> Eliminar</a>
							  	</div>
							  	</c:otherwise>
							</c:choose>
				   		   	</c:when>
				   		   	<c:otherwise>
				   		   		...
				   		   		<div id="cradio6" style="width:200px; position: absolute;  top:7px; FONT-SIZE: 8pt;  font-weight: bold; left:65%;">
					          			  <a  href="javascript:Regresarbandeja();" title="Regresar a Bandeja Documentos" ><img src="img/01regresar.png"  width="16" height="16" border="0" align="top"> Regresar</a>
    									  <a  href="javascript:deletedocument(<c:out value='${FFormDocumentoInternoEspecialC.codigo_documento_interno}' />)" title="Eliminar Documento"><img src="img/02eliminar.png" alt="Anular Documentos" width="16" height="16" border="0" align="top"> Eliminar</a>
							  </div>
				    		...
				    		<span class="labelrounded">DOCUMENTO POR FIRMAR</span> 
				   		   	...
				   		   	<c:choose>
				   		   		<c:when test='${verbotonesbandeja =="1"}'>
    									...
    									<a  href="javascript:Regresabandejare()" title="Regresar a la Bandeja de Reiterativo" ><img src="img/01regresar.png"  width="16" height="16" border="0" align="top"> Regresar</a>
    									<a  href="javascript:deletedocumentinicia(<c:out value='${FFormDocumentoInternoEspecialC.codigo_documento_interno}' />)" title="Eliminar Documento"><img src="img/02eliminar.png"  width="16" height="16" border="0" align="top"> Eliminar</a>
 						    	...
 						    	<c:otherwise>
				   		   	...
				   		   	<c:otherwise>
				   		   	<c:choose>
				   		   	<c:when test='${FFormDocumentoInternoEspecialC.tipo_envio =="R" || FFormDocumentoInternoEspecialC.tipo_envio =="D"}'>
    ...
    <c:if test='${es_admiitido==0 && FFormDocumentoInternoEspecialC.codigo_documento eq 0 && FFormDocumentoInternoEspecialC.codigo_documento_interno eq null}'>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" ><html:radio property="radiobuttons" value="1"><bean:message key="sistema.documento.internos.ccp" /></html:radio></a>
			...
			<tr>
				   <td  style="padding:0px; margin:0px;" align="left" valign="middle" >
				   		...
				   		<tr>
				  			...
				  			<td  align="left" valign="middle" >
				    			<html:text property="firmado_por" size="50"  styleId="firmado_por" />
				   		...
				   		<tr>
				   			<td  align="right" valign="middle" class="label" >
				    			<bean:message key="sistema.documento.internos.motivo" />
				  			</td>
				  			<td  align="left" valign="middle" >
				    			 <html:textarea property="motivo" cols="60" rows="2"  styleId="motivo" /> 
								 <span class="error"><br><html:errors property="motivo"/></span>
				  			</td>
				   		...
				   		<tr>
				  			...
				  			<td  align="left" valign="middle" >
				    			 <html:textarea property="actividad" cols="60" rows="2"  styleId="actividad" /> 
				   		...
				   		<tr>
				  			...
				  			<td  align="left" valign="middle" >
				  				<table id="tablamadre" width="60%">
				  				
				  				<tr ><td align="left" valign="baseline" class="label">
				  				<bean:message key="sistema.documento.internos.meta" />
				  				</td> 
				  				<td align="left" valign="baseline" class="label">
				  				...
				  				<td  align="left" valign="top" ><html:text property="meta" size="35"  styleId="meta" />
				  				</td>
				  				</tr>
				  				</table>
				  				</td>
				  				...
				  				<tr >
				  				<td  align="left" valign="middle" >
				  				<div id="cradio7" style="width:90px; position: relative;  top:0px; FONT-SIZE: 8pt;  font-weight: bold; left:20%;" >
					          			  <a  title="Adicionar" href="javascript:addNewRow(event)">[+]</a>
    									  <a  title="Remover" href="javascript:removeLastRow(event)">[-]</a>
							  	</div>
				  				</td>
				  				</tr>
				  				</table>
				  				...
				  				<tr><td align="left" valign="baseline" class="label">
				  				<bean:message key="sistema.documento.internos.especifica" />
				  				</td> 
				  				<td align="left" valign="baseline" class="label">
				  				<bean:message key="sistema.documento.internos.valor" />
				  				</td>
				  				</tr>
				  				<tr>
				  				<td>
				  				<table id="tabla2">
				  				<tr id="celda" class="celda">
				  				<td  align="left" valign="top" ><html:text property="especifica" size="35"  styleId="especifica" />
				  				</td>
				  				</tr>
				  				</table>
				  				</td>
				  				...
				  				<table id="tabla3">
				  				<tr id="celda" class="celda">
				  				<td  align="left" valign="top" ><html:text property="valor" size="35"  styleId="valor" />
				  				</td>
				  				</tr>
				  				</table>
				  				</td>
				  				</tr>  
			  					<tr><td align="left" valign="baseline" colspan="2" class="label">
				  				<bean:message key="sistema.documento.internos.observacion" />
				  				</td> 
				  				</tr>
				  				</table>
					  		</td>
				   		...
				   		<tr>
				  			...
				  			<td  align="left" valign="middle" >
				    			<table id="tabla4" align="left">
				  				<tr id="celda" class="celda">
				  				<td  align="left" valign="middle" >
				  				<html:textarea property="observacion" cols="60" rows="2"  styleId="observacion" />
				  				</td>
				  				</tr>
				  				</table>
				  			</td>
				   		...
				   		<tr>
				   			<td  align="right" valign="middle" class="label" >
				    			<bean:message key="sistema.documento.internos.nota" />
				  			</td>
				  			<td  align="left" valign="middle" >
				    			 <html:textarea property="nota" cols="60" rows="2"  styleId="nota" /> 
								 <span class="error"><br><html:errors property="nota"/></span>
				  			</td>
						 ...
						 <tr><td colspan="2" height="15px" >
				   		...
				   		<tr>
				   			<td  align="center" valign="top" class="label" colspan="2" >
									 ...
									 <c:when test='${FFormDocumentoInternoEspecialC.codigo_documento_interno eq null }'>
									      <c:choose>
									      <c:when test='${es_admiitido==0 && ls_respuesta != "respuesta"}'>
									      <html:button  styleId="btnguardar" value="Guardar" style="width: 90;" property="" styleClass="button" onclick="this.disabled=true; this.value='GUARDANDO...'; Guardar();" />
					         		 ...
					         		 <c:choose>
					         		 	...
					         		 	<c:otherwise>
					         		 	<html:button  styleId="btnguardar" value="Actualizar" style="width: 90;" property="" styleClass="button" onclick="this.disabled=true; this.value='ACTUALIZANDO...'; Guardar();" />
    ...
    <li><a href="#tabsbusqueda-1">Documentos Internos Encontrados</a></li>
  	...
  	<table width="100%" cellpadding="0" cellspacing="0">
			 ...
			 <tr>
				  ...
				  <display:table name="sessionScope.listaDocumentosInternosBusqueda"  requestURI="/MostrarFormularioCrearcionDocumentoInternoEspecialC.do?inicia=SI#tabsbusqueda-1"
  ...
  <table width="100%">
			 ...
			 <tr>
				  <td align="center" colspan="2">				  
				  <display:table name="sessionScope.listaDocumentosInternosN" requestURI="/MostrarFormularioCrearcionDocumentoInternoEspecialC.do?inicia=SI#tabs-1"
				  export="false" sort="list" id="b" 
				  pagesize="8"  class="simple" style="width: 90%" >
  ...
  <table width="100%">
			 ...
			 <tr>
				  <td align="center" colspan="2">				  
				  <display:table name="sessionScope.listaDocumentosInternosD"  requestURI="/MostrarFormularioCrearcionDocumentoInternoEspecialC.do?inicia=SI#tabs-2"
				  export="false" sort="list" id="b" 
				  pagesize="8"  class="simple" style="width: 90%" >
  ...
  <table width="100%">
			 ...
			 <tr>
				  <td align="center" colspan="2">				  
				  <display:table name="sessionScope.listaDocumentosInternosR"  requestURI="/MostrarFormularioCrearcionDocumentoInternoEspecialC.do?inicia=SI#tabs-3"
				  export="false" sort="list" id="b" 
				  pagesize="8"  class="simple" style="width: 90%" >
  ...
  <table width="100%">
			 ...
			 <tr>
				  <td align="center" colspan="2">				  
				  <display:table name="sessionScope.listaDocumentosInternosProyectos" requestURI="/MostrarFormularioCrearcionDocumentoInternoEspecialC.do?inicia=SI#tabsproyectos-1"
				  export="false" sort="list" id="b" 
				  pagesize="8"  class="simple" style="width: 90%" >
    ...
    <table width="100%">
			 ...
			 <tr>
				  <td align="center" colspan="2">				  
				  <display:table name="sessionScope.listaDocumentosInternosProyectosRecibidos" requestURI="/MostrarFormularioCrearcionDocumentoInternoEspecialC.do?inicia=SI#tabsproyectos-2"
				  export="false" sort="list" id="b" 
				  pagesize="8"  class="simple" style="width: 90%" >
