...
function LlamarPuente(){
 ...
 function Buscar(){
	...
	//document.forms[0].action="ListaDocumentosFirmados.do?tipo=seguimiento_archivos";
	document.forms[0].submit();
	 $( "#dialog-confirm" ).dialog( "open");
}
...
<div class="container">
	...
	<html:form   enctype="multipart/form-data"  action="ListaDocumentosFirmados.do?tipo=seguimiento_archivos" >
	...
	<div id="TDHeadCab">
				    		...
				    		<span class="labelrounded">BUSQUEDA DE ARCHIVOS </span> 
	<c:choose>
	<c:when test='${verReporteDocumentoInternos == "1"}'>
     ...
     <p>
	    <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bean:message key="sistema.documento.internos.area.destino" /></label>
    	<html:select property="codigo_oficina" styleId="codigo_oficina"  styleClass="input">			             
    	...
    	<p>
     	<label ><bean:message key="sistema.documento.internos.nombre.archivo" /></label>
     	<html:text property="nombre_arhivo" styleId="nombre_arhivo"  style="width: 290px;" styleClass="input"/>	
     	</p>
  ...
  <ul>
    <li><a href="#tabsbusquedabandeja">Archivos Encontrados</a></li>
  </ul>
  ...
  <div id="tabsbusquedabandeja">
	...
	<table width="100%" cellpadding="0" cellspacing="0">
			 ...
			 <tr>
				 ...
				 <display:table name="sessionScope.listaArchivosBusqueda"  
				  ...
				  pagesize="8"  class="simple" style="width: 90%" >
				  						...
				  						<display:column property="nombre_arhivo" title="Nombre de Archivo" sort="true" width="250"/>
				  						
				  						<display:column  title="Oficina Origen" sort="true">
				  						
					  						<logic:iterate id="oficina" name="areasAdministrativasList">					  										  						
						  							<c:if test="${b.codigo_oficina_pertenece==oficina.codigo_oficina}">
				  						...
				  						<display:column  title="Oficina Destino" sort="true">
					  						...
					  						<logic:iterate id="oficina_destino" name="areasAdministrativasList">					  										  						
						  							<c:if test="${b.codigo_oficina==oficina_destino.codigo_oficina}">
						  								<c:out value="${oficina_destino.descripcion_oficina}"/>
						  							</c:if>
						  					</logic:iterate>
				  						</display:column>
				  						
				  						<display:column  title="Asunto documento" property="asunto" width="350"/>
