...
String es_oficina_maxima = (String)session.getAttribute("es_oficina_maxima_ls");
%>
	...
	$( "#cradio9" ).buttonset();
	  ...
	  /* $('#botoninvisible').click(function() {
	   ...
	   $('#botoninvisible').click(function(e) {
	         ...
	         refDialog = $('<iframe id="site" src="mostrarlistasdebandejadocumentosinternos.do?cambia=3" />').dialog({
	   ...
	   $("#botoninvisibleProyectos").mouseover(function(event){
		...
		$('#botoninvisibleProyectos').click(function(e) {
	        ...
	        var horizontalPadding = 15;
	        var verticalPadding = 15;
	        refDialog = $('<iframe id="site" src="mostrarlistasdebandejadocumentosinternos.do?cambia=4" />').dialog({
	            title: ($this.attr('title')) ? $this.attr('title') : 'Site',
	            autoOpen: true,
	            width: 1000,
	            height: 300,
...
function modificarIframe(valor){
	var strURL = "ModificarDocumentoInternoEspecialC.do?cod_doc_interno="+valor;
	location=strURL;
...
function modificarIframeProyectos(valor){
	var strURL = "ModificarDocumentoInternoEspecialC.do?cod_doc_interno="+valor+"&tipo_pi=1";
	location=strURL;
...
function modificarIframeMisProyectos(cod_doc_int_origen,codigo_documento_interno,codigo_documento){
	var strURL = "ModificarDocumentoInternoEspecialC.do?cod_doc_interno="+cod_doc_int_origen+"&cod_proy="+codigo_documento_interno+"&numreg="+codigo_documento+"&tipo_pi=2";
	location=strURL;
...
function Cambiacondicion(valentrada){
	...
	var es_oficina_maximap = "<%=es_oficina_maxima%>";
	
	//alert(valentradap+","+es_oficina_maximap);
	if(valentradap==1){
		if(es_oficina_maximap == null){
			$("#v-ocultar").hide();
			$("#v-ocultar-2").hide();
			$("#v-ocultar-3").hide();
			$("#v-ocultar-4").hide();
			...
			if(es_oficina_maximap == "1"){
				...
				$("#cuadrodelcheck-show").hide();
				$("#cuadrodelcheck-hide-nooficinamaxima").show();
				$("#botoninvisible").hide();
			}
		}
...
<script language="JavaScript" type="text/javascript">
 ...
 function Continuar(){
	 ...
	 $(document).ready(function(){
		 $("#cuadro-docs-adjuntos").load("actualizaDocumentoAdjunto.do", {cambia:'actualizaccp'});
			...
			<tr>
				   <td  style="padding:0px; margin:0px;" align="left" valign="middle" >
				   		...
				   		<tr>
				  			...
				  			<div id="cuadrodelcheck-hide-nooficinamaxima" style="display:none;">
				  			<input type="checkbox" name="checkboxdeactivado-oficinamaxima" value="Car"  disabled="disabled"> 
				  			</div>
				   		...
				   		<tr>
				  			...
				  			<td  align="left" valign="middle" >
				  			<div class="ui-widget">
				    			<html:text property="abreviatura_grado_profesion"  size="10" styleId="abreviatura_grado_profesion"  styleClass="input-medium" onkeypress="return validatecla('texto',this)" />
				   		...
				   		<tr>
				  			...
				  			<td  align="left" valign="middle" >
				    			 <html:textarea property="motivo"   styleId="motivo"  style="width:500px; height:90px;" styleClass="textarea"/> 
				   		...
				   		<tr>
				   			<td  align="right" valign="top" class="label" >
				    			<bean:message key="sistema.documento.internos.objeto.requerimiento" />
				  			</td>
				  			<td  align="left" valign="middle" >
				    			<table width="100%" border="0">
				    			<tr>
				    			<td align="left" valign="baseline" width="30%"> 
								<html:select property="codigo_tipo_requerimiento" styleId="codigo_tipo_requerimiento" styleClass="input-medium" style="width:180px;">			             
					             	<html:option value="0" >Seleccionar</html:option>
									<html:options collection="tipoRequerimientoList"  property="idBean"
 									labelProperty="nombreBean"  /> 
								</html:select> 
								<span class="error"><br><html:errors property="codigo_tipo_requerimiento"/></span>
				    			</td>
				    			<td align="left" valign="middle" rowspan="3" width="70%">
				    			<html:textarea property="descripcion"   styleId="descripcion" style="width:315px; height:90px;" styleClass="textarea"/> 								
								<span class="error"><br>
								<html:errors property="descripcion"/></span>
				    			</td>
				    			</tr>
				   		...
				   		<tr>
				   			<td  align="right" valign="middle" class="label" >
				    			<bean:message key="sistema.documento.internos.actividad.poi" />
				  			</td>
				  			<td  align="left" valign="middle" >
				   		...
				   		<tr>
				  			...
				  			<td  align="left" valign="middle" >
				    			 <html:textarea property="meta"  styleId="meta"  style="width:500px; height:50px; " styleClass="textarea"/>
								 <span class="error"><br><html:errors property="meta"/></span>
				  			</td>
				   		
				   		</tr>
				   		<tr>
				   			<td  align="right" valign="middle" class="label" >
				    			<bean:message key="sistema.documento.internos.otros" />
				  			</td>
				  			<td  align="left" valign="middle" >
				    			 <html:textarea property="observacion"   styleId="observacion"  style="width:500px; height:50px; " styleClass="textarea"/>
				  			</td>
