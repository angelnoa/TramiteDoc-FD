...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function fn_grabar(){
			with(document.forms[0]){
				if(trim(nombre_solicitud.value) == ""){
		...
		function fn_editar(pcodigo_solicitud,pnombre_solicitud){
			with(document.forms[0]){
			
				codigo_solicitud.value = pcodigo_solicitud;
				nombre_solicitud.value = pnombre_solicitud;
	...
	<body topmargin="0" leftmargin="0" onload="fn_onLoad();">
		<html:form action="/MantSolicitud" method="POST">
					  ...
					  <table align="center" cellspacing="0" cellpadding="2" width="100%" border="0">
							...
							<tr>
								...
								<td colspan="2" align="left" valign="middle" style="width: 400px;">
								  <html:text property="codigo_solicitud" style="width: 100px;" maxlength="20" styleClass="caja"
							...
							<tr>
								...
								<td colspan="2" align="left" valign="middle" style="width: 400px;">
								  <html:text property="nombre_solicitud" style="width: 330px;" maxlength="90" styleClass="caja" />
							  </td>
								<td style="width: 10px;">&nbsp;
				...
				<tr>
					<td>
						<table width="100%" align="center" cellpadding="0" cellspacing="0">
							<tr>
								<td>
									<display:table name="sessionScope.listasolicitud" export="false" sort="list" id="b" pagesize="10"
										...
										<display:column property="codigo_solicitud" title="Codigo" style="width: 50px; text-align: center;" />
										<display:column property="nombre_solicitud" title="Descripci&oacute;n" />
