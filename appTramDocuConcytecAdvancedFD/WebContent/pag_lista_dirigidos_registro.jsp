...
$(function() {
  $("#dialog-message-modifica").dialog({
    ...
    buttons: {
      Ok: function() {
    	  if($("#texto_modifica").val().length < 4) {
    		  $("#texto_modifica").focus();
...
{ 
	 var operacion = 'dirigidoa';
	document.getElementById("usu_tipo_valor").value='interno';
	$("#div_frame_listas").load("obtenerLista.do",{cambia:operacion,tipo_busqueda:'limpialista'});
}

function deshabilita(form)
{ 
	 var operacion = 'dirigidoa';
	document.getElementById("usu_tipo_valor").value='externo';
	$("#div_frame_listas").load("obtenerLista.do",{cambia:operacion,tipo_busqueda:'limpialista'});
}
...
function mostrar_lista(){
	...
	$(document).ready(function(){
	    ...
	    var ls_operacion = $("#sel_opcion").val();
	    var ls_accion = $("#accion").val();
	    var ls_tipo_busqueda = $("#usu_tipo_valor").val();

	    var operacion = 'dirigidoa';
	    //llama al servlet con el parametro seleccionado
	    $("#div_frame_listas").load("obtenerLista.do",{cambia:operacion,ls_texto:value,operacion:ls_operacion,accion:ls_accion,tipo_busqueda:ls_tipo_busqueda});
...
function agrega_a_lista(){
	...
	if(document.getElementById("usu_tipo_valor").value=='interno'){
		alert("Usted no esta autorizado para agregar nuevo personal");
	}else{
...
<form id="form_datos" name="form_datos" method="post" action="" >
 ...
 <INPUT  type="hidden" id="usu_tipo_valor" name="usu_tipo_valor" value="interno">
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0 height="100%">
    ...
    <TBODY>
      ...
      <TR> 
        <TD height="100%" align="center" valign="top"  style="WIDTH: 100%" class="tablaArbitraje" >
            ...
            <tr> 
              <td height="273" colspan="5" valign="top" width="100%"> 
                <table width="100%" cellpadding="0" cellspacing="0" >
                    ...
                    <td height="50" colspan="3" align="left"  > <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr> 
                          <td  align="center" colspan="6">
                          	<input type="radio" name="boletin" value="si" checked onClick="habilita(this.form)"><strong> Usuarios Internos.</strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="boletin" value="no" onClick="deshabilita(this.form)"><strong> Usuarios Externos.</strong>
							<br><br><br><br>
                  ...
                  <tr> 
                    <td width="100%" align="center" valign="top" height="220" colspan="3"> 
