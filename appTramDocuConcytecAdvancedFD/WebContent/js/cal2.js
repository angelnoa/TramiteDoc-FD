...
function showCal(name) {
  ...
  if (currentCal != null && currentCal.form != null && currentCal.form[currentCal.field]) {
	...
	/*alert("winX: " + winX);
	alert("winY: " + winY);
	alert("calOffsetX: " + calOffsetX);
	alert("calOffsetY: " + calOffsetY);*/
...
function pickDate(d) {
  ...
  if(currentCal.form[currentCal.field].form.name == "TomarAsistenciaForm" 
  		&& currentCal.form[currentCal.field].name == "fechaAsistencia"){
	  self.actualizarControlAsistencia();
  }
}
// ------
