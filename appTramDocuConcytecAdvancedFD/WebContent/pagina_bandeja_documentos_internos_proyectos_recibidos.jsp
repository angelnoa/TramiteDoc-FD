...
$(function() {
    $( "#dialog-confirm-retorno-documentos-normales" ).dialog({
      autoOpen: false,	
      resizable: false,
      width:380,
      height:240,
      modal: true,
      buttons: {
        "Retornar documento": function() {
          var codigo = $( this ).dialog( "option", "appendTo" );
          var observacion=$("#observacion-proyecto").val();
          var strURL = "FormularioBusquedaDocumentoInterno.do?inicia=SI&tipo=firmasolicitada&operacion=retorna&cod_doc_interno="+codigo+"&observacion="+observacion;
          location = strURL;
          $( this ).dialog( "close" );
        },
        Cancelar: function() {
          $("#observacion-proyecto").val("");	
          $( this ).dialog( "close" );
		...
		$("#enviar-complemento").click(function () {
			...
			if(tipofirma==0){
				...
				if(tipofirma==1){
					...
					if(tipofirma==2){
						srtURL = "UtilidadActualizacionRegistroMovimiento.do?operacion=confirma&codDoc="+codigo+"&codTip="+tipo+"&observacion="+observacion+"&tipoenvio="+tipoenvio;
						location = srtURL;
						return;
					}
				}
...
function retornaabandeja(codDoc){
	var coddoc = codDoc;
		
	$( "#dialog-confirm-retorno-documentos-normales" ).dialog({ appendTo: coddoc });
	$( "#dialog-confirm-retorno-documentos-normales" ).dialog( "option", "appendTo", coddoc );
	$( "#dialog-confirm-retorno-documentos-normales" ).dialog( "open");

}

function firmaSolicitada(codigo_documento_interno,codigo_tipo_documento,tipoenviop){
	var codigo=codigo_documento_interno;
	var tipo=codigo_tipo_documento; 
	var tipoenvio=tipoenviop; 
	//alert(codigo+","+tipo+","+tipoenvio);
	var strURL = "CopiaRequeridaPDFATemporal.do?pass=xxxxxxx&codDoc="+codigo+"&codTip="+tipo+"&tipoenvio="+tipoenvio+"&log=0020034";
	winPopup = window.open(strURL,"Firma_Digital","scrollbars=YES,resizable=YES,location=NO,WIDTH=730,HEIGHT=430");
}
...
function MostrarMensaje(mensaje,coDoc){
	...
	if(mensajez == 0){
		var strURL = "UtilidadActualizacionRegistroMovimiento.do?operacion=updatefirmaovisto&codigo_documento_interno="+codocu+"&codigo_oficina="+<c:out value='${FFormBusquedaDocumentoInterno.codigo_oficina_pertenece}'></c:out>;	
		location=strURL;
		return;
	}
...
<div class="container">
	...
	<div id="dialog-confirm-retorno-documentos-normales" title="Mensaje de Alerta" >
  		<p><span class="ui-icon ui-icon-alert" style="float: left; margin: 0 7px 20px 0; font-size : 8px; "></span>
  		El documento será retornado al remitente.</p>
  		<div style="margin-left:20px; margin-top:20px; ">
    	<p>Observacion:</p>
    	<textarea rows="4" cols="40" id="observacion-proyecto" class="textarea"></textarea>
    	<br></div>
	...
	<div id="TDHeadCab">
		<c:if test='${vista_firma=="1"}'>
		<span class="labelrounded">BANDEJA DOCUMENTOS INDIVIDUALES A FIRMAR</span>
		</c:if>
		<c:if test='${vista_firma=="0"}'>
		<span class="labelrounded">BANDEJA DOCUMENTOS INDIVIDUALES A VISTO BUENO</span>
		</c:if>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:CambiardocumentoBandeja(2)" ><html:radio property="radiobuttons" value="2" onclick="CambiardocumentoBandeja(2)"><bean:message key="sistema.documento.internos.ccp" /></html:radio></a>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:CambiardocumentoBandeja(3)" ><html:radio property="radiobuttons" value="3" onclick="CambiardocumentoBandeja(3)"><bean:message key="sistema.documento.internos.tdr" /></html:radio></a>
	</c:when>
	<c:otherwise>
	<a href="#" ><html:radio property="radiobuttons" value="1" ><bean:message key="sistema.documento.internos.normales" /></html:radio></a>
  ...
  <div id="tabsbusquedabandeja">
	<table width="100%" cellpadding="0" cellspacing="0">
			 ...
			 <tr>
				  ...
				  <display:table name="sessionScope.listaDocumentosInternosBusqueda"  requestURI="/FormularioBusquedaDocumentoInterno.do?inicia=SI&tipo=firma#tabsbusquedabandeja"
	...
	<c:choose>
	  ...
	  <div id="tabs">
	  <ul>
	   	<li><a href="#tabsbandeja-1">Proyectos con Firma Solicitada</a></li>
