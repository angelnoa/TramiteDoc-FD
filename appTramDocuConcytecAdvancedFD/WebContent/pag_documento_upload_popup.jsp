...
function eliminar_archivo(id){
	...
	location = "Busquedas.do?tipo=eli_archivo_deriva&id="+id;
	}

} 
	
function cerrar(){
	window.opener.MostrarAdjunto();
	window.close();
}
...
function Aceptar(){
	...
	document.form_datos.action='MantDerivar.do'+'?operacion='+ls_operacion+'&tipo=uploadficheros'+'&codigo_documento='+ls_codigo_documento+'&codigo_expediente='+ls_codigo_expediente+'&secuencia_movimiento='+ls_secuencia_movimiento+'&modo='+ls_modo_observacion;
	document.form_datos.submit();	
	//window.close();
}
function Modificar(){
      ...
      <TD width="1249" height="100%" valign="top"  > <CENTER>
          <TABLE width="100%" cellpadding="0" cellspacing="0">
            <TR> 
              <TD width="978" height="49" valign="middle" bgcolor="#BAD0EB" class="titulolistado01" ><FONT size="2">&nbsp; 
                DERIVAR DOCUMENTOS - ADJUNTAR ARCHIVOS
                </FONT></TD>
            </TR>
          </TABLE>
          <TABLE width="100%" border="0"  >
					...
					<table width="100%" border="1" cellpadding="0" cellspacing="0">
					  <!--DWLayoutTable-->
					    <tr> 
					      ...
					      <td width="619" align="center" valign="middle" class="Columna10"  background="img/fondoplomo8.gif">aaaNombre del Archivo      </td>
								      ...
								      <td align="left" valign="middle" class="Columna">&nbsp;&nbsp;&nbsp; 
								        <c:out value='${pr.nombre_archivo}'/> </td>
										   ...
										   <td align="center" valign="middle" class="Columna">   <c:choose>
										     ...
										     <c:otherwise>
								  				<a target="_blank" href="ListaDocumentos.do?tipo=uploaddoc&nombre_archivo=<c:out value='${pr.nombre_archivo}'/>&fileroute=<c:out value='${pr.ruta_archivo}'/>">Ver Archivo</a>	</c:otherwise>
										     </c:choose>	  </td>
								    		<td align="center" valign="middle">  
								    		<!-- input type="radio" name="group1" checked="checked" value="Milk"-->
								    		<A id="A1" target="_parent" href="MantDerivar.do?tipo=eliminar&id_det_upload=<c:out value='${pr.id_det_upload}'/>&codigo_documento=<c:out value='${codigo_documento}'/>">
					  ...
					  <c:when test='${operacion ==  "N"}'>
							<table width="100%" border="1" cellpadding="0" cellspacing="0">
							    ...
							    <td width="68" valign="top" background="img/fondoplomo8.gif"><!--DWLayoutEmptyCell-->&nbsp;</td>
							      ...
							      <c:forEach items='${FFormMantDerivar.archivos}' var='ar' varStatus="c"> 
							      ...
							      <td align="left" valign="middle" class="Columna"><c:out value="${ar.nombre_archivo}"></c:out></td>
									   ...
									   <td align="center" valign="middle" class="Columna"><a href="Busquedas.do?tipo=ver_archivo_deriva&id=<c:out value='${c.count-1}'/>">Visualizar</a></td>
            ...
            <TR>
			  ...
			  <!-- input  type="button" class="boton2"  name="button" value="Cerrar"  onClick="javascript:cerrar('<c:out value='${contador}'/>');"-->
			  <input  type="button" class="boton2"  name="button" value="Cerrar"  onClick="javascript:cerrar();">
			  </TD>
            </TR>
          </TABLE>
        </CENTER></TD>
