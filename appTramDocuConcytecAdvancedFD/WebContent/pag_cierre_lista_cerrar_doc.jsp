				...
				<tr>
				  ...
				  <table align="center" cellspacing="0" cellpadding="2" width="100%" border="0">
                            ...
                            <tr>
                              ...
                              <td align="left" valign="middle" class="label">
                              <input type="text" readonly="readonly" value="<c:out value="${FFormMantCerrar.codigo_guia_courier}"/>">
                              </td>
                              <td style="width: 10px;">&nbsp;</td>
                            </tr>
                            <tr>
				   ...
				   &nbsp;dd/mm/yyyy	</td>
                            ...
                            <tr>
                              <td height="23" style="width: 10px;">&nbsp;</td>
                              <td style="width: 90px;" class="label" align="left"><!--DWLayoutEmptyCell-->&nbsp;</td>
                              <td class="label"><!--DWLayoutEmptyCell-->&nbsp;Documentos:</td>
                              <td align="left" valign="middle" class="label"><!--DWLayoutEmptyCell--><c:out value="${FFormMantCerrar.paqueteDocs}"/></td>
							...
							<tr>
								<td>
									<display:table name="sessionScope.listado_pendientes" export="false" sort="list" id="b" pagesize="10"
										...
										<display:column property="detallePaquete" title="Documentos Seleccionados" />
