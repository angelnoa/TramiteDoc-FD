...
select md.codigo_documento,md.fecha_movimiento,md.hora_movimiento,md.estado_movimiento,md.codigo_inicia,md.secuencia_movimiento,
md.ultimo_usuario,md.doc_deriva,md.observa_movimiento,md.codigo_motivo,md.ultimo_usuario,md.codigo_inicia,tp.descripcion_tipo
,dc.numero_documento,dc.naturaleza_documento,de.origen_documento,de.destino_documento,de.desc_origen,de.tipo,de.remitente,de.destinatario
,of.codigo_oficina,of.descripcion_oficina
...
de.destino_documento=of.codigo_oficina and
md.codigo_oficina like '0001' and md.codigo_fondo like '01' and  md.fecha_movimiento
>= '2008-12-08' and  md.fecha_movimiento <= '2008-12-08' order by  md.fecha_movimiento desc, md.hora_movimiento
desc, md.codigo_documento desc
