...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function fn_grabar(){
			with(document.forms[0]){
				if(trim(descripcion_tipo.value) == ""){
		...
		function fn_editar(pcodigo_tipo,pdescripcion_tipo){
			with(document.forms[0]){
			
				codigo_tipo.value = pcodigo_tipo;
	...
	<body topmargin="0" leftmargin="0" onload="fn_onLoad();">
		<html:form action="/MantTipoDocumento" method="POST">
					  ...
					  <table align="center" cellspacing="0" cellpadding="2" width="100%" border="0">
							...
							<tr>
								...
								<td colspan="2" align="left" valign="middle" style="width: 400px;">
								  <html:text property="codigo_tipo" style="width: 100px;" maxlength="20" styleClass="caja"
							...
							<tr>
								...
								<td colspan="2" align="left" valign="middle" style="width: 400px;">
								  <html:text property="descripcion_tipo" style="width: 330px;" maxlength="90" styleClass="caja"
										onkeypress="return validatecla('letras', this);" />
							  </td>
								<td style="width: 10px;">&nbsp;
				...
				<tr>
					<td>
						<table width="100%" align="center" cellpadding="0" cellspacing="0">
							<tr>
								<td>
									<display:table name="sessionScope.listatipodoc" export="false" sort="list" id="b" pagesize="10"
										...
										<display:column property="codigo_tipo" title="Codigo" style="width: 50px; text-align: center;" />
										<display:column property="descripcion_tipo" title="Descripci&oacute;n" />
