...
<FORM id="form_datos" name="form_datos" action="" method="post">
    <TABLE align="center" width="60%" border="1" bordercolor="#E9E9E9" cellpadding="0" cellspacing="0">
	 <TR>
	   <TD align="center" class="TextFieldOn35" colspan="2" bgcolor="e9e9e9"><font color="#000000" size="2" ><strong>Recibir un Documento</strong></font></TD>
	 </TR>
	<TR>
	<TD>
          ...
          <TBODY>
            <TR> 
              <TD width="135" height="20" align="right" valign="middle" class="formulario"> 
                N&deg; Registro: </TD>
              <TD width="171" align="left" valign="middle"> &nbsp;&nbsp;<c:out value='${documento}'/> 
              </TD>
              <TD width="120" align="right" valign="middle" class="formulario"> 
                N&deg; Expediente:</TD>
              <TD width="147" align="left" valign="middle">&nbsp;&nbsp;<c:out value='${codigo_expediente}'/></TD>
            </TR>
            <TR> 
            ...
            <TR> 
              <TD height="22" align="right" valign="middle" class="formulario" > 
                Fecha: </TD>
            ...
            <TR> 
              <TD height="74" align="right" valign="middle" class="formulario"> 
