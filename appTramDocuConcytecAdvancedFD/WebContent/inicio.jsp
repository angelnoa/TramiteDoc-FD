...
<link href="theme/css3/style-adicional.css" rel="stylesheet"
	type="text/css" />
...
<style>
  ...
  .card {
  background-image: url(img/fondo_centro_nuevo.png);
...
function ingresoTradicional(){
	
	$("#cambiavistalogueo").load("cambiaModoInicioLogin.do?");
...
<!-- End Google Login Styles -->
<title>Sistema de Tramite Documentario **-CONCYTEC-**</title>
</head>
<body>
	
	<div id="cambiavistalogueo" style="display:none;"></div>
	<div>
		<!-- <div id="cent" style="height: 550px; background-image: url(img/nt_back1.png);"> -->
		<div id="cent" >
			
			<div id="rsi-card" class="card signin-card">
				
				<br /> <br /> <br /> <br /> <br /> <br /> <br /> <br /><br />
				<!-- a	href="#" onclick="ingresoTradicional()"> 
					<input type="submit" name="signIn"
					class="rc-button rc-button-submit" style="height:70px; font-size: 15px; line-height: 20px;" value="Iniciar sesión &#x00A; de Forma Tradicional &nbsp;" />
				</a  -->
				    
				<a	href="index.jsp"> <input type="submit" name="signIn"
					class="rc-button rc-button-submit" style="height:40px; font-size: 15px; line-height: 20px;" value="Con correo electrónico Institucional &nbsp;" />
