            ...
            <tr> 
              <td height="273" colspan="5" valign="top" width="100%"> 
                ...
                <tr valign="middle"> 
                  ...
                  <tr valign="middle"> 
                    <td height="50" colspan="3" align="left"  > <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr> 
                          ...
                          <td align="center" valign="middle"> <input type="text" name="sle_texto" id="sle_texto" size="40" class="caja"  onKeyPress="ver_frame()" /> 
                          ...
                          <td align="center" valign="middle"> <input type="button" name="btn_buscar" id="btn_buscar" class="boton" value="Buscar" onClick="ver_frame()" alt="buscar"  ></td>
                          ...
                          <td align="center" valign="middle"> <input type="button" name="btn_agregar" id="btn_agregar" class="boton" value="Agregar" onClick="agregar()" alt="Agregar"  ></td>
                  ...
                  <tr> 
                    <td align="center" valign="top" height="220"> <IFRAME id="ifra_frame_listas"  name="ifra_frame_listas" src="VerFrameListas.do?tipo=dirigidos&accion=<c:out value='${accion}'/>" align="middle"  frameBorder="0" width="100%"   scrolling="auto" height="100%"  marginheight="30%"  ></IFRAME> 
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
