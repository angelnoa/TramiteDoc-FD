...
public class AActionMantDocumento extends ValidaSessionAction{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		Collection rs_upload_doc=null;
		 rs_upload_doc = new ArrayList();
		...
		codigo_personal = ((FFormMantDocumento)form).getCodigo_personal();
		nombreapellido_usuario = ((FFormMantDocumento)form).getNombreapellido_usuario();
		c_usuario = ((FFormMantDocumento)form).getC_usuario();
		cargo_personal = ((FFormMantDocumento)form).getCargo_personal();
		oficina = ((FFormMantDocumento)form).getOficina();
		es_responsable = ((FFormMantDocumento)form).getEs_responsable();
		tipo_firma = Integer.valueOf(((FFormMantDocumento)form).getTipo_firma());
		
		validacion=((FFormMantDocumento)form).getValidacion();
		//usuarioper = ((FFormMantPersonal)form).getUsuarioper();
		codigoUsuarioBuscar = ((FFormMantDocumento)form).getCodigoUsuarioBuscar();
		...
		try {
			...
			if(tipo.equals("buscar")){
				...
				rs_upload_doc = daoIUsuarioDAO.lista_upload_documentos_detalle(cnx,
						Integer.parseInt(codigoUsuarioBuscar.trim()));
