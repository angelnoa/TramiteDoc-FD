 ...
 */
        ...
        private String caracteresValidosUsuario = "[A-Z|a-z|0-9|ñ|Ñ|á|é|í|ó|ä|ë|ö|ü|ç|à|è|ì|ò|ù]";
 ...
 */
        ...
        * @return boolean En función del resultado, retorna true si se cumple o false si la comprobación es incorrecta
        */
        public boolean validaCampoNumeros(String numero, boolean obligatorio, String cadena, int maximo, boolean fijo){
                String campo = numero.trim();
                if (obligatorio){
                        if (campo.length() <= 0){
                                setMensajeError(cadena + ".vacio");
                                return false;
        ...
        * @param cadena string que se muestra en caso de error
        * @return boolean En función del resultado, retorna true si se cumple o false si la comprobación es incorrecta
        * Los métodos indexOf() y lastIndexOf() se utilizan frecuentemente con substring(), que devuelve una subcadena 
        * de una cadena. La siguiente clase ilustra el uso de lastIndexOf() y substring() para aislar diferentes partes de un nombre de fichero. 
        */
        public boolean validaEmail(String email, String cadena, boolean obligatorio){
        ...
        */
        public boolean validaFecha(String fecha, String cadena,boolean obligatorio)
        {
                ...
                if (campo.length() > 0)
                {
                        ...
                        int anio;
                        try{
                        	dia = new Integer (fech1[0]).intValue();
                            mes = new Integer (fech1[1]).intValue();
                            anio = new Integer (fech1[2]).intValue();
                        	}
						catch(Exception e){
							dia = 90;
                            mes = 90;
        ...
        * @param obligatorio indica si el campo es o no obligatorio
        * @param minimo tamaño mínimo de campo
        * @param maximo tamaño máximo del campo
