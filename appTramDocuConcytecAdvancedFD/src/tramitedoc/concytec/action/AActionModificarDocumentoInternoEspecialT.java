...
import tramitedoc.concytec.util.BarradeProgreso;
	...
	public class AActionModificarDocumentoInternoEspecialT extends Action {
		protected  Log log = LogFactory.getLog(AActionModificarDocumentoInternoEspecialT.class);
		  ...
		  public ActionForward execute(ActionMapping mapping,
				    ...
				    throws Exception
				  {
			  		log.info("Entry AActionModificarDocumentoInternoEspecialT... ");
			  		...
			  		FFormDocumentoInternoEspecialT fformDocumentoInterno = (FFormDocumentoInternoEspecialT) form; //TDD
					...
					/********************/
			  		...
			  		DocumentoInternoBean documentoInterno = service.getDocumentoInterno(codigo_documento_interno,tipo_documento);
				    ...
				    request.getSession().setAttribute("areasAdministrativasList",areasAdministrativasList);
			  		...
			  		request.setAttribute("verbotonescreacion", "1");//para la vista pag_creaciondocinterno
			  		log.info("Sali del AActionModificarDocumentoInternoEspecialT ");
				    return mapping.findForward("exito");
