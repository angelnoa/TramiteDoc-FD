 ...
 */
public class FFormDocumentoInterno extends ValidatorForm {
	/**
	 * 
	 */
	//private static final long serialVersionUID = 4152512310908945280L;
	protected  Log log = LogFactory.getLog(FFormDocumentoInterno.class);
	/**
	 * 
	 */
	...
	public void reset(ActionMapping mapping, HttpServletRequest request) {
		// TODO Auto-generated method stub
		 ...
		 _documentoInternoBean.setFirmantes_destino(new String[0]);
		 _documentoInternoBean.setVisto_bueno_destino(new String[0]);
	...
	/*	 private String stringMultibox[] = new String[0];
		...
		*/
		    ...
		    public String[] getFirmantes_destino() {
		        return (this._documentoInternoBean.getFirmantes_destino());
		    }
		    
		    public String[] getVisto_bueno_destino() {
		        return (this._documentoInternoBean.getVisto_bueno_destino());
		    }
		    ...
		    public void setFirmantes_destino(String[] firmantes_destino) {
		    	this._documentoInternoBean.setFirmantes_destino(firmantes_destino);
		    }

		    public void setVisto_bueno_destino(String stringMultiboxdos[]) {
		    	this._documentoInternoBean.setVisto_bueno_destino(stringMultiboxdos);
		    }
