 ...
 */
public class FFormMantSeguimientoDocumentoInterno extends ValidatorForm {
	/**
	 * 
	 */
	//private static final long serialVersionUID = 4152512310908945280L;
	protected  Log log = LogFactory.getLog(FFormMantSeguimientoDocumentoInterno.class);
	/**
	 * 
	 */
	...
	public FFormMantSeguimientoDocumentoInterno(){
	...
	/*	 private String stringMultibox[] = new String[0];
		...
		*/
			...
			public String getFecha_inicio() {
				return _documentoInternoBean.getFecha_inicio();
			}
			public void setFecha_inicio(String fecha_inicio) {
				_documentoInternoBean.setFecha_inicio(fecha_inicio);
			}	
			
			public String getFecha_fin() {
				return _documentoInternoBean.getFecha_fin();
			}
			public void setFecha_fin(String fecha_fin) {
				_documentoInternoBean.setFecha_fin(fecha_fin);
			}	
