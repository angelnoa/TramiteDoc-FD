...
import tramitedoc.concytec.bean.DocumentoInternoBean;
	 ...
	 */
	public class FFormDocumentoInternoEspecialT extends ValidatorForm {
		/**
		 * 
		 */
		//private static final long serialVersionUID = 12469779538084343L;
		protected  Log log = LogFactory.getLog(FFormDocumentoInternoEspecialT.class);
		/**
		 * 
		 */
		...
		public FFormDocumentoInternoEspecialT(){
		...
		public String getObjetivo() {
			return _documentoInternoBean.getObjetivo();
		}
		public void setObjetivo(String objetivo) {
			_documentoInternoBean.setObjetivo(objetivo);
		}
		
		public String getJustificacion() {
			return _documentoInternoBean.getJustificacion();
		}
		public void setJustificacion(String justificacion) {
			_documentoInternoBean.setJustificacion(justificacion);
		}
		
		public String getFinalidad() {
			return _documentoInternoBean.getFinalidad();
		}
		public void setFinalidad(String finalidad) {
			_documentoInternoBean.setFinalidad(finalidad);
		}
		
		public String getEntregable() {
			return _documentoInternoBean.getEntregable();
		}
		public void setEntregable(String entregable) {
			_documentoInternoBean.setEntregable(entregable);
		}
		
		public String getPlazo() {
			return _documentoInternoBean.getPlazo();
		}
		public void setPlazo(String plazo) {
			_documentoInternoBean.setPlazo(plazo);
		}
		
		public String getFinanciamiento() {
			return _documentoInternoBean.getFinanciamiento();
		}
		public void setFinanciamiento(String financiamiento) {
			_documentoInternoBean.setFinanciamiento(financiamiento);
		}
		
		public String getModalidad() {
			return _documentoInternoBean.getModalidad();
		}
		public void setModalidad(String modalidad) {
			_documentoInternoBean.setModalidad(modalidad);
		}
		
		public String getResponsable_coordinacion() {
			return _documentoInternoBean.getResponsable_coordinacion();
		}
		public void setResponsable_coordinacion(String responsable_coordinacion) {
			_documentoInternoBean.setResponsable_coordinacion(responsable_coordinacion);
		}
		
		public String getResponsable_conformidad() {
			return _documentoInternoBean.getResponsable_conformidad();
		}
		public void setResponsable_conformidad(String responsable_conformidad) {
			_documentoInternoBean.setResponsable_conformidad(responsable_conformidad);
		}
