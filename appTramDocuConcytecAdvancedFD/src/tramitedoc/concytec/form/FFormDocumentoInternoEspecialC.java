...
import tramitedoc.concytec.bean.DocumentoInternoBean;
	 ...
	 */
	public class FFormDocumentoInternoEspecialC extends ValidatorForm {
		/**
		 * 
		 */
		//private static final long serialVersionUID = -1219199361720127416L;
		protected  Log log = LogFactory.getLog(FFormDocumentoInternoEspecialC.class);
		/**
		 * 
		 */
		...
		protected String _meta1form;
		protected String _meta2form;
		protected String _meta3form;
		protected String _meta4form;
		
		protected String _especifica1form;
		protected String _especifica2form;
		protected String _especifica3form;
		protected String _especifica4form;
		
		protected String _valor1form;
		protected String _valor2form;
		protected String _valor3form;
		protected String _valor4form;
		
		protected String _observacion1form;
		protected String _observacion2form;
		protected String _observacion3form;
		protected String _observacion4form;
		...
		public void setMeta1form(String meta1form){ _meta1form = meta1form; }
	    public String getMeta1form(){ return _meta1form; }
		
	    public void setMeta2form(String meta2form){ _meta2form = meta2form; }
	    public String getMeta2form(){ return _meta2form; }
	    
	    public void setMeta3form(String meta3form){ _meta3form = meta3form; }
	    public String getMeta3form(){ return _meta3form; }
	    
	    public void setMeta4form(String meta4form){ _meta4form = meta4form; }
	    public String getMeta4form(){ return _meta4form; }
	    
		
		public void setEspecifica1form(String especifica1form){ _especifica1form = especifica1form; }
	    public String getEspecifica1form(){ return _especifica1form; }
		
	    public void setEspecifica2form(String especifica2form){ _especifica2form = especifica2form; }
	    public String getEspecifica2form(){ return _especifica2form; }
	    
	    public void setEspecifica3form(String especifica3form){ _especifica3form = especifica3form; }
	    public String getEspecifica3form(){ return _especifica3form; }
	    
	    public void setEspecifica4form(String especifica4form){ _especifica4form = especifica4form; }
	    public String getEspecifica4form(){ return _especifica4form; }
	    
	    
		public void setValor1form(String valor1form){ _valor1form = valor1form; }
	    public String getValor1form(){ return _valor1form; }
		
	    public void setValor2form(String valor2form){ _valor2form = valor2form; }
	    public String getValor2form(){ return _valor2form; }
	    
	    public void setValor3form(String valor3form){ _valor3form = valor3form; }
	    public String getValor3form(){ return _valor3form; }
	    
	    public void setValor4form(String valor4form){ _valor4form = valor4form; }
	    public String getValor4form(){ return _valor4form; }
	    
	    
		public void setObservacion1form(String observacion1form){ _observacion1form = observacion1form; }
	    public String getObservacion1form(){ return _observacion1form; }
		
	    public void setObservacion2form(String observacion2form){ _observacion2form = observacion2form; }
	    public String getObservacion2form(){ return _observacion2form; }
	    
	    public void setObservacion3form(String observacion3form){ _observacion3form = observacion3form; }
	    public String getObservacion3form(){ return _observacion3form; }
	    
	    public void setObservacion4form(String observacion4form){ _observacion4form = observacion4form; }
	    public String getObservacion4form(){ return _observacion4form; }
		...
		public FFormDocumentoInternoEspecialC(){
		...
		public Integer getNumerofilas() {
			return _documentoInternoBean.getNumerofilas();
		}
		public void setNumerofilas(Integer numerofilas) {
			_documentoInternoBean.setNumerofilas(numerofilas);
		}
		...
		/*	 private String stringMultibox[] = new String[0];
			...
			*/
				...
				public Integer getCodigo_tipo_requerimiento() {
					return _documentoInternoBean.getCodigo_tipo_requerimiento();
				}
				public void setCodigo_tipo_requerimiento(Integer codigo_tipo_requerimiento) {
					_documentoInternoBean.setCodigo_tipo_requerimiento(codigo_tipo_requerimiento);
				}
